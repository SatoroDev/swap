import { ChainId, JSBI, Percent, Token } from '@pancakeswap-libs/sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

// import { bsc, fortmatic, injected, portis, walletconnect, walletlink } from '../connectors'
import { injected, bsc } from '../connectors'
// TODO
export const ROUTER_ADDRESS = '0x61934F31eE682A8dD43844Ff20a4D51531127b8B'
...
export const WETHM = new Token(ChainId.MAINNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Binance Token')
export const WETH = new Token(ChainId.BSCTESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Binance Token')
export const RSGP = new Token(ChainId.BSCTESTNET, '0xF0D0776329c87d0B49A0B2b7093c6E4c45dd4f36', 18, 'RSGP', 'RSGP Token')


const WETH_ONLY: ChainTokenList = {
  [ChainId.MAINNET]: [WETHM],
  [ChainId.BSCTESTNET]: [WETH]
}
